...
<div class="am-panel am-panel-default">
    ...
    <div class="am-panel-bd">
    	<form class="am-form" id="upodateManagerForm"  method="post">
    		<div class="am-g">
...
$(function(){
	 ...
	 $('#updateManagerForm').validate({
                ...
                submitHandler: function() {
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/admin/manager/updateManager.action",
                        data: $("#updateManagerForm").serialize(),
                        dataType: "json",
                        type: "POST"
